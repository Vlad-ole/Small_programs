...
class AvalancheMC_My {
 ...
 public:
  ...
  bool DriftPositron(const double x0, const double y0, const double z0,
                     const double t0);
  bool DriftElectronBothWays(const double x0, const double y0, const double z0,
                     const double t0);
  ...
  //My addition
  void setLoopPrecision (double pres);
  double getLoopPrecision (void) const;
  void setLoopCheckDepth (int N_check);
  double getLoopCheckDepth (void) const;
  bool moveElectronAlongDriftLine(int N_points, double distance, int order);
  void writeFieldAlongDriftLine (std::ostream& str, double min_dl, double &L);
